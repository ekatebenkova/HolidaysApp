...
public class MainActivity extends AppCompatActivity implements GetDataFromInternet.AsyncResponse,
        AdapterHoliday.ListItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            URL url = new URL("https://calendarific.com/api/v2/holidays?api_key={your_api_key}&country=RU&year=2024");
    ...
    public void processFinish(String output) {
        ...
        try {
            ...
            recyclerView.setAdapter(new AdapterHoliday(listHolidaysInfo, length, this));
